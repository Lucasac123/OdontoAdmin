    ...
    <div className="p-4 border-t border-white/5">
      <div className="flex flex-col gap-4 mb-4 px-2">
        ...
        <div className="flex bg-black/20 p-1 rounded-xl relative">
          <motion.div 
            className="absolute top-1 bottom-1 w-[calc(33.33%-4px)] bg-zinc-800 rounded-lg shadow-sm"
            initial={false}
            animate={{
          ...
          <button 
            ...
            className={`flex-1 flex items-center justify-center p-2 rounded-lg transition-colors relative z-10 ${theme === 'light' ? 'text-white' : 'text-text-secondary hover:text-white'}`}
            title="Modo Claro"
          >
          ...
          <button 
            ...
            className={`flex-1 flex items-center justify-center p-2 rounded-lg transition-colors relative z-10 ${theme === 'system' ? 'text-white' : 'text-text-secondary hover:text-white'}`}
          ...
          <button 
            ...
            className={`flex-1 flex items-center justify-center p-2 rounded-lg transition-colors relative z-10 ${theme === 'dark' ? 'text-white' : 'text-text-secondary hover:text-white'}`}
            title="Modo Escuro"
          >
